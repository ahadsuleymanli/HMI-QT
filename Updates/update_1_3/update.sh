...
sudo cp update_1_4/autovip_ls .
sudo cp update_1_4/autovip_ls backup/autovip_ls.last
...
sudo cp update_1_4/AutoUpdater2 .
sudo cp update_1_4/AutoUpdater2 backup/AutoUpdater2.last
sudo chmod +x AutoUpdater2


sudo cp update_1_4/proto.ini .
sudo cp update_1_4/settings.ini .

sudo cp update_1_4/restore.sh backup/restore.sh
