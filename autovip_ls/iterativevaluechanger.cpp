...
IterativeValueChanger::IterativeValueChanger(QString name, int increment_delay_ms, singleIterationCallback callback1_ptr, singleIterationCallback callback2_ptr)
{
    this->name = name;
    this->callback1_ptr = callback1_ptr;
    this->callback2_ptr = callback2_ptr;
